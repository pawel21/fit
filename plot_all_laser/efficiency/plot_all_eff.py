...
ax1= plt.subplot(221)
ax1.plot(l635_current_25, dP_635_current, 'b-', label="laser krawędziówy 635\,nm")
ax1.plot(l850_edge_current_25, dP_850_edge_current, 'g-', label="laser krawędziówy 850\,nm")
...
ax3 = plt.subplot(223)
ax3.plot(l980_current, dP_980_vcsel_current, 'b-', label="laser VCSEL 980\,nm")
ax3.plot(l850_vcsel_current_25, dP_850_vcsel_current, 'g-', label="laser VCSEL 850\,nm")
...
ax2 = plt.subplot(222)
ax2.plot(input_power_635, dP_635_power, 'b-', label="laser krawędziowy 635\,nm")
ax2.plot(input_power_850_edge, dP_850_edge_power, 'g-', label="laser krawędziowy 635\,nm")
...
ax4 = plt.subplot(224)
ax4.plot(input_power_980_vcsel, dP_980_vcsel_power, 'b-', label="laser VCSEL 980\,nm")
ax4.plot(input_power_850_vcsel, dP_850_vcsel_power, 'g-',label="laser VCSEL 850\,nm")
...
plt.subplots_adjust(left=0.08, right=0.95, top=0.93, bottom=0.1, hspace=0.29, wspace=0.320)
plt.show()