...
\end{itemize} 
Python posiada także biblioteki (np. $\mathtt{Shutil}$) do operowania plikami(jak przenoszenie, usuwanie) co jest często przydatne. Połączenie bibliotek wymienionych powyżej umożliwiło stworzenia programu, który komunikuje i steruje sprzętem. A następnie na podstawie uzyskanych danych, wykonałem ich analize.
