...
current_5, voltage_5, power_5 = np.loadtxt("temp_10.txt", unpack=True, skiprows=1)
...
ax1 = plt.subplot(211)
ax1.plot(current_5 * 1000, voltage_5, 'rh', label="283 K", markersize=MARKER_SIZE)
...
ax2 = plt.subplot(212)
ax2.plot(current_5 * 1000, power_5 * 1000, 'rh', label="283 K", markersize=MARKER_SIZE)
