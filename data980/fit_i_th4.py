...
class Find_I_th:
    ...
    def _fit_plot(self, start_to_fit, end_to_fit):
        ...
        plt.text(start_to_fit - 0.1 * start_to_fit, -0.11,
...
l980_temp_10 = Find_I_th("temp_10.txt")
#l980_temp_10._fit_plot(0.9, 4)

l980_temp_25 = Find_I_th("temp_25.txt")
#l980_temp_25._fit_plot(1.1, 6.2)

l980_temp_60 = Find_I_th("temp_60.txt")
#l980_temp_60._fit_plot(1.6, 5)

l980_temp_90 = Find_I_th("temp_90.txt")
l980_temp_90._fit_plot(2.45, 5.5)

ax1 = plt.subplot(221)
ax1.plot(l980_temp_10.current, l980_temp_10.power, 'r^')
a_10, b_10, _, _ = l980_temp_10.do_fit(0.9, 4)
x_10 = np.linspace(0.8, 4)
y_10 = a_10*x_10 + b_10
ax1.plot(x_10, y_10, 'b-')
ax1.set_xlim([0, 4])
ax1.set_ylim([-0.25, 1.5])
ax1.text(0.9, -0.2, "$I_{th}$ = (%.2f $\pm$ %.2f)\,mA" % (1.00, 0.04), size=20)
...
ax2 = plt.subplot(222)
ax2.plot(l980_temp_25.current, l980_temp_25.power, 'r^')
a_25, b_25, _, _ = l980_temp_25.do_fit(1.1, 6.2)
x_25 = np.linspace(0.9, 6.2)
y_25 = a_25*x_25 + b_25
ax2.plot(x_25, y_25, 'b-')
ax2.set_xlim([0, 4])
ax2.set_ylim([-0.25, 1.3])
ax2.text(0.9, -0.2, "$I_{th}$ = (%.2f $\pm$ %.2f)\,mA" % (1.05, 0.02), size=20)
...
ax3 = plt.subplot(223)
ax3.plot(l980_temp_60.current, l980_temp_60.power, 'r^')
a_60, b_60, _, _ = l980_temp_60.do_fit(1.6, 5)
x_60 = np.linspace(1.5, 5.2)
y_60 = a_60*x_60 + b_60
ax3.plot(x_60, y_60, 'b-')
ax3.set_xlim([0, 4])
ax3.set_ylim([-0.25, 1.3])
ax3.text(1.5, -0.2, "$I_{th}$ = (%.2f $\pm$ %.2f)\,mA" % (1.59, 0.04), size=20)
...
ax4 = plt.subplot(224)
ax4.plot(l980_temp_90.current, l980_temp_90.power, 'r^')
a_90, b_90, _, _ = l980_temp_90.do_fit(2.6, 5)
x_90 = np.linspace(2.3, 5.0)
y_90 = a_90*x_90 + b_90
ax4.plot(x_90, y_90, 'b-')
ax4.set_xlim([0, 4])
ax4.set_ylim([-0.25, 0.8])
ax4.text(2.4, -0.15, "$I_{th}$ = (%.2f $\pm$ %.2f)\,mA" % (2.48, 0.06), size=20)
