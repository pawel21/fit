...
x_90, y_90 = ple90.plot_slope_efficiency_via_current(2.7)
current_90, _, output_power_90 = ple90.get_data()
a_90, b_90, c_90 = ple90.fit_via_current_poly_2(2.7)
current_90_fit, _ = ple90.get_data_to_fit_via_current(2.7)
dP_90 = 2*a_90 * current_90_fit + b_90
x_slope_90, slope_90 = ple90.fit_step_by_step_via_current(2.7, 10)


ple20 = PlotLaserEfficiency("temp_20.txt")
x_20, y_20 = ple20.plot_slope_efficiency_via_current(1.5)
current_20, _, output_power_20 = ple20.get_data()
a_20, b_20, c_20 = ple20.fit_via_current_poly_2(1.5)
current_20_fit, _ = ple20.get_data_to_fit_via_current(1.5)
dP_20 = 2*a_20 * current_20_fit + b_20
x_slope_20, slope_20 = ple20.fit_step_by_step_via_current(1.5, 10)
